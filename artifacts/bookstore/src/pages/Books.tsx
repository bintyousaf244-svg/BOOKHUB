      ...
      <div className="container mx-auto px-4 py-10">
        <div className="flex flex-col lg:flex-row gap-8 items-start">
          ...
          <aside className="w-full lg:w-64 flex-shrink-0 sticky top-20">
            <div className="rounded-2xl p-6 space-y-5 shadow-sm" style={{ background: "white", border: `1px solid hsl(33,20%,85%)` }}>
              <h2 className="font-bold font-serif text-base" style={{ color: PURPLE }}>Filter Books</h2>

              <div className="space-y-1.5">
                <Label className="text-xs font-semibold uppercase tracking-wide" style={{ color: "hsl(270,20%,48%)" }}>Search</Label>
                <div className="relative">
                  <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4" style={{ color: "hsl(270,20%,55%)" }} />
                  <Input placeholder="Search books..." className="pl-9 rounded-xl border-[hsl(33,20%,85%)]"
              ...
              {[
                ...
                <div key={f.label} className="space-y-1.5">
                  <Label className="text-xs font-semibold uppercase tracking-wide" style={{ color: "hsl(270,20%,48%)" }}>{f.label}</Label>
                  <Select value={f.value} onValueChange={f.onChange}>
                    <SelectTrigger className="rounded-xl border-[hsl(33,20%,85%)]">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
          ...
          <main className="flex-1 w-full">
            {isLoading ? (
              ...
              <>
                <p className="text-sm mb-5" style={{ color: "hsl(270,20%,48%)" }}>
              ...
              <div className="flex flex-col items-center justify-center py-20 rounded-2xl text-center"
                style={{ background: "white", border: `1px solid hsl(33,20%,85%)` }}>
                <div className="text-5xl mb-4">📭</div>
                <h3 className="text-xl font-serif font-bold mb-2" style={{ color: PURPLE }}>No books found</h3>
                <p className="mb-5" style={{ color: "hsl(270,20%,48%)" }}>Try adjusting your filters to find what you're looking for.</p>
                <button onClick={resetFilters}
